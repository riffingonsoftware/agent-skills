...
2. Rewrite. Preserve meaning, required syntax, and intended tone.
3. Add soul where the format permits (see next section).
...
- **Acknowledge complexity.** "Impressive but also kind of unsettling" beats "impressive," but extra fluff is unnecessary (see previous point).
