...
Recommend skills for the next agent in a "suggested skills" section. Reference existing artifacts (plans, tickets, commits, diffs) by path or URL instead of duplicating them. Redact sensitive information, including credentials and personally identifiable information.
